...
_.reject = function(array, callback){
    return _.filter(array, function(elem, i, a){
       if(!callback(array[i], i, array)){
           return array[i];
       }
    });
...
_.partition = function(array, callback){
    ...
    finalArray.push(trueArray, falseArray);
    return finalArray;
};
...
//             let results = callback(e, i, a);
//             savedValue.push(results);
//         });
//     } else{
//         for(let key in collection){
//             let resultsObj = callback(collection[key], key, collection);
//             savedValue.push(resultsObj);
//         }
//     } 
//     return savedValue;
...
_.pluck = function(array, property){
    return _.map(array, function(elem, i, a){
...
_.extend = function(...objects){
    _.each(objects, function(object, index, objects){
        for(let key in object){
            objects[0][key] = objects[index][key];
        }
    });
    return objects[0];
};
